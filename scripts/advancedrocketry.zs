...
PrecisionAssembler.addRecipe(<advancedrocketry:blocklens>, 1200, 10000, <minecraft:glass>*3, <advancedrocketry:lens>*3, <immersiveengineering:material:1>);
PrecisionAssembler.addRecipe(<advancedrocketry:atmanalyser>, 1200, 10000, <advancedrocketry:misc>, <libvulpes:battery>, <advancedrocketry:ic:2>, <advancedrocketry:lens>, <thermalfoundation:material:321>);
PrecisionAssembler.addRecipe(<advancedrocketry:beaconfinder>, 1200, 10000, <advancedrocketry:ic:1>, <advancedrocketry:itemupgrade:4>);
PrecisionAssembler.addRecipe(<advancedrocketry:biomechanger>, 1200, 10000, <advancedrocketry:ic:1>, <advancedrocketry:ic:2>, <advancedrocketry:misc>, <libvulpes:battery>, <thermalfoundation:material:321>);
PrecisionAssembler.addRecipe(<advancedrocketry:satelliteprimaryfunction:5>, 1200, 10000, <libvulpes:productrod:4>*2, <libvulpes:productrod:7>, <advancedrocketry:wafer>, <advancedrocketry:ic:2>);


PrecisionAssembler.addRecipe(<advancedrocketry:itemupgrade:2>, 2400, 25000, <libvulpes:motor>, <advancedrocketry:ic:2>, <advancedrocketry:ic:3>);
PrecisionAssembler.addRecipe(<advancedrocketry:itemupgrade:3>, 2400, 25000, <advancedrocketry:ic:3>, <advancedrocketry:ic:2>, <minecraft:feather>, <minecraft:leather_boots>);
